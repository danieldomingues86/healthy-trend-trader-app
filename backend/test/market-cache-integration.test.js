...
test('Real market refresh functions share the provider guard and retain historical timestamps',async t=>{
 ...
 const oldCache=process.env.MARKET_CACHE_PATH,oldDirectory=process.env.BRAPI_CACHE_DIRECTORY,oldLiveScans=process.env.ENABLE_BRAPI_LIVE_SCANS,oldB3Hist=process.env.B3_HISTORY_CACHE_DIRECTORY,oldB3Idx=process.env.B3_INDEX_HISTORY_CACHE_DIRECTORY;
 ...
 process.env.B3_HISTORY_CACHE_DIRECTORY=path.join(directory,'b3-history');process.env.B3_INDEX_HISTORY_CACHE_DIRECTORY=path.join(directory,'b3-index');
