(function (root) {
  const widgets = [
    ...
    ,{ id: 'courage-challenge', name: 'Desafio A/A+', description: 'Progresso do sizing compliance no desafio atual.', category: 'Disciplina & Rotina', icon: '✓', defaultSize: 'medium', minSize: 'compact', route: 'couragechallenge', defaultActive: false, render: (context) => context.renderChallenge() }
