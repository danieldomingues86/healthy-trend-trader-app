(function () {
  ...
  function render() {
    ...
    root.innerHTML = `<div id="dailyRoutineCardContainer"></div><main class="today-cockpit">
    ...
    renderTopHeat();
    if (typeof window.DailyRoutineController?.renderDailyRoutineCard === 'function') {
      window.DailyRoutineController.renderDailyRoutineCard();
    }
  }
