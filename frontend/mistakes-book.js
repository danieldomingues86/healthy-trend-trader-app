(function () {
  ...
  function render() {
    ...
    root.querySelectorAll('.mb-book-tabs').forEach(tabs => tabs.insertAdjacentHTML('beforeend', `<button class="${state.section === 'marketLessons' ? 'active' : ''}" data-market-lessons>${lang('Lições importantes', 'Important lessons')}</button>`));
