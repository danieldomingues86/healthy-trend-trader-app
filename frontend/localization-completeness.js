(function () {
  ...
  const copy = {
    ...
    'A Rubric autoriza um orçamento de risco; o perfil ativo define quanto dele pode ser executado com segurança.': 'The Rubric authorizes a risk budget; the active profile defines how much can be executed safely.',
    ...
    'Qualidade → Risk Budget → limitadores → risco executável → Position Size': 'Quality → Risk Budget → limiters → executable risk → Position Size',
    ...
    'Percentual máximo de risco executável pelo stop.': 'Maximum executable stop-risk percentage.',
    'Limite de volatilidade': 'Volatility limit',
    'Parâmetro da camada de volatilidade / ATR.': 'Parameter used by the volatility / ATR layer.',
    'Volatilidade em andamento': 'Ongoing volatility',
    'Limite de capital': 'Capital limit',
    'Percentual máximo da equity alocado em uma posição.': 'Maximum equity percentage allocated to one position.',
    'Portfolio Heat máximo': 'Maximum Portfolio Heat',
    'Risco agregado máximo deste perfil.': 'Maximum aggregate risk for this profile.',
    'Máximo de posições': 'Maximum positions',
    'Quantidade simultânea permitida neste perfil.': 'Simultaneous positions allowed by this profile.',
    'Grade & Risk Budget': 'Grade & Risk Budget',
    'Quanto arriscar por qualidade do trade (Notas A, B, C e D)': 'How much to risk by trade quality (Grades A, B, C and D)',
    'Define o risco financeiro máximo autorizado de acordo com a nota de qualidade da oportunidade. Oportunidades com maior confluência de edges permitem mais risco; notas menores reduzem ou bloqueiam a exposição para proteger seu capital.': 'Defines the maximum authorized financial risk according to the opportunity quality grade. Opportunities with greater confluence of edges allow more risk; lower grades reduce or block exposure to protect your capital.',
    'Pesos de cada edge': 'Weights of each edge',
    'Defina o peso de cada critério na avaliação da oportunidade no Novo Trade. O total obrigatório é 100 pontos.': 'Set the weight of each criterion when evaluating the opportunity in New Trade. The required total is 100 points.',
    'A qualidade da oportunidade define apenas o teto autorizado; os limitadores do perfil calculam o risco executável.': 'Opportunity quality defines only the authorized ceiling; profile limiters calculate executable risk.',
    'Orçamento de Risco': 'Risk Budget',
    ...
    'Exportar Diário': 'Export Journal',
    'Exportar Diário do Trader': 'Export Trader Journal',
    'Copiar para IA': 'Copy to AI',
    'Baixar arquivo': 'Download file',
    'Preparar para análise por IA': 'Prepare for AI analysis',
    ...
    'Todo o histórico': 'Full history',
    'Ambos (Técnico + Emocional)': 'Both (Technical + Emotional)',
    'Análise Fundamentalista': 'Fundamental Analysis',
    'Empresa analisada': 'Company analyzed',
    'Preço atual': 'Current price',
    'Adicionar à Watchlist': 'Add to Watchlist',
    'Score Fundamentalista': 'Fundamental Score',
    'Cobertura dos dados': 'Data coverage',
    'Como esta nota foi calculada': 'How this score was calculated',
    'Auditoria e Transparência': 'Audit & Transparency',
    'Soma das Contribuições': 'Sum of Contributions',
    'Raio-X Fundamentalista': 'Fundamental X-Ray',
    'Visão Abrangente': 'Comprehensive Overview',
    'Consistência de Lucros Líquidos': 'Net Income Consistency',
    'Destaques Qualitativos': 'Qualitative Highlights',
    'Takeaway para o Trader': 'Trader Takeaway',
    'Fonte dos dados': 'Data source',
    'Sincronizado em': 'Synchronized at',
    'Dados históricos indisponíveis': 'Historical data unavailable',
